...
exports.addProductsSchema = {
  body: Joi.object({
    ...
    link_1: Joi.string().optional().allow("", null),
    link_2: Joi.string().optional().allow("", null),
    link_3: Joi.string().optional().allow("", null),
...
exports.allProductsSchema = {
  query: Joi.object({
    ...
    is_view: Joi.string().valid("true", "false", "all"),
    sort: Joi.object({
